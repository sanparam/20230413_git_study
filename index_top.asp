          ...
          <td bgcolor="#000000" height="30"> 
            <table width="650" border="0" cellspacing="0" cellpadding="0" class="txt_white">
              <tr valign="middle" align="center"> 
                <td><a href="info.asp"  target="content"><b>통합구매</b>소개</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<!--                <td><a href="auction/re_good_list.asp" target="content">입찰신청</a></td> -->
                ...
                <!--<td><a href="javascript:window.open('http://www.mangchi.co.kr')">센서/스위칭전용매장</a></td>//-->
				<td><a href="javascript:window.open('http://mangchi.macro21.com')">센서/스위치 전용매장</a></td>
				<td><a href="javascript:window.open('http://jboard.macro21.com')">사업안내</a></td>
			   </tr>
            </table>
          </td>
        </tr>
